...
const copy = {
  en: {
    ...
    p3: "However, the Bluevera Standard Framework goes beyond just handing over the keys. Our true value is integrating you into a vibrant, established community. From day one, we connect you with trusted English-speaking medical facilities, local clubs, and fellow winter residents. You have complete independence, but you are never alone.",
