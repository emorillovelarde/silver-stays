...
const copy = {
  en: {
    ...
    p3: "You shouldn't have to spend your retirement fighting with paperwork or worrying about rental scams. That is exactly why we created the Bluevera Standard Framework. We only work with properties we have verified in person, under strict long-term contracts (LAU), and we manage the complex local logistics for you.",
  ...
  es: {
    ...
    p3: "Su retiro no debería consistir en lidiar con papeleo. Por eso creamos el Bluevera Standard Framework. Verificamos en persona todas nuestras propiedades, garantizamos contratos de larga temporada seguros (LAU) y gestionamos la logística local por usted.",
