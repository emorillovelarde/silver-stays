  ...
  <DialogPortal>
    ...
    >
      <DialogPrimitive.Close
        className="absolute right-4 top-4 rounded-sm opacity-60 hover:opacity-100 transition-opacity text-gray-600 hover:text-[#1A1A1A] focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
