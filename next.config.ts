    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://esm.sh https://challenges.cloudflare.com https://*.mailerlite.com https://*.mlcdn.com https://assets.mlcdn.com https://connect.facebook.net",
              "script-src-elem 'self' 'unsafe-inline' https://esm.sh https://challenges.cloudflare.com https://*.mailerlite.com https://*.mlcdn.com https://assets.mlcdn.com https://connect.facebook.net",
              ...
              "img-src 'self' https://images.unsplash.com data: https://*.mailerlite.com https://*.mlcdn.com https://assets.mlcdn.com https://www.facebook.com https://*.facebook.com",
              "connect-src 'self' https://*.supabase.co https://challenges.cloudflare.com https://*.mailerlite.com https://*.mlcdn.com https://assets.mlcdn.com https://www.facebook.com https://*.facebook.com",
